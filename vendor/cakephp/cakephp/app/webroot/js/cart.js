$(function() {
    ...
    $(".products").append(`<span class="m-2">Total: ${Math.round((sum + Number.EPSILON) * 100) / 100} ${localStorage.getItem("currency")}</span>`);
