    ...
    <div id="registerForm">
        <?php
			...
			<div class='input date'>
				<label for='registerUserFormBirthDate'></label>
				<input name='data[registerUserForm][birthDate]' placeholder='".__("birth_date").
				"' type='date' id='registerUserFormBirthDate' max='".date('Y-m-d', strtotime('-18 year'))."'>
			</div>";
