...
<div id="main">
    ...
    <div id="registerForm">
        <?php
            ...
            echo $this->Form->input("birthDate", array("type" => "text", "label" => "", "placeholder" => __("date_format")));
            ...
            echo $this->Form->input("houseNumber", array("type" => "text", "label" => "", "placeholder" => __("house_number")));
            echo $this->Form->input("flatNumber", array("type" => "text", "label" => "", "placeholder" => __("flat_number")));
            echo $this->Form->input("idNumberAndSeries", array("type" => "text", "label" => "", "placeholder" => __("id")));
