...
<div id="text" class="offset-1 col-10">
	...
	<ul>
		...
		<li>
			<p>
				...
				in this Agreement) refers to Alpha Tech LLC.
			</p>
		</li>
		<li>
			<p>
		...
		<li>
			<p>
				...
				refers to AlphaTech, accessible from
				<a href="https://www.alphatech.com" rel="external nofollow noopener" target="_blank">
	...
	<p>Y
		ou are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are
	...
	<ul>
		<li>
			By visiting this page on our website:
				<a href="https://www.alphatech.com/privacy-policy-and-cookies" rel="external nofollow noopener"
				   target="_blank">https://www.alphatech.com/privacy-policy-and-cookies</a>
		</li>
	</ul>`
</div>
