<?php
    ...
    echo $this->Form->input("start", array("type" => "date", "label" => "", "dateFormat" => "YMD", "label" => __("holiday_start_date")));
    echo $this->Form->input("end", array("type" => "date", "label" => "", "dateFormat" => "YMD", "label" => __("holiday_end_date")));
    ...
    if ($this->Session->read("leaveRequestSent")) {
        echo "<script>Swal.fire({icon: 'success',text: '".__("leave_request_sent")."',showConfirmButton: true,timer: 5000,timerProgressBar: true});</script>";
