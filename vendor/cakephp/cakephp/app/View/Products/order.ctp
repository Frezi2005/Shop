        ...
        <?php
            ...
            echo $this->Form->input("city",
				array(
					...
					"required" => true,
					"pattern" => "[a-zA-Z\s]+",
					"value" => isset($userInfo) ? $userInfo["city"] : ""
				)
			);
            echo $this->Form->input("street",
				array(
					...
					"required" => true,
					"pattern" => "[\da-zA-Z\s]+",
					"value" => isset($userInfo) ? $userInfo["street"] : ""
				)
			);
            echo $this->Form->input("house_number",
				array(
					...
					"value" => isset($userInfo) ? $userInfo["house_number"] : ""
				)
			);
            echo $this->Form->input("flat_number",
				array(
					...
					"required" => true,
					"pattern" => "([1-9])([0-9]*)",
					"value" => isset($userInfo) ? $userInfo["flat_number"] : ""
				)
			);
            ...
            echo $this->Form->input("deliveryType",
				array(
					"label" => __("delivery_type"),
					"options" => array(
						"" => __("choose"),
						"courier" => __("courier"),
						"pickup_point" => __("pickup_point"),
						"parcel_locker" => __("parcel_locker")
					),
					"required" => true
				)
			);
			...
			echo $this->Form->hidden("exchangeRate");
